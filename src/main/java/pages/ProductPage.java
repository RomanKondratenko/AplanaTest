...
public class ProductPage extends BasePage {
    ...
    public void setSize() {
        ...
        new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(completedRefreshSerp));
    }
    ...
    public void selectFiltersTV() {
        ...
        new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(processRefreshSerp));
        new WebDriverWait(driver, 20).until(ExpectedConditions.presenceOfElementLocated(completedRefreshSerp));
    }
